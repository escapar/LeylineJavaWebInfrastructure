 ...
 * @author George Wei
 */
public class WhalinMemcachedClientFactory implements MemcacheClientFactory {
    ...
    public static final String DEFAULT_ERROR_HANDLER = "moe.src.leyline.framework.infrastructure.cache.memcached.hibernate.WhalinMemcachedErrorHandler";
    ...
    public WhalinMemcachedClientFactory(PropertiesHelper properties) {
...
//        client.setCompressEnable(isCompressEnable());
        ...
        return new WhalinMemcachedCache(client, poolName);
    }
